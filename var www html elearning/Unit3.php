...
if (isset($_POST['lessoneml'])){
    $_SESSION['lessoneml3'] = $_POST['lessoneml'];
    return;
}

if (isset($_POST['quizeml'])){
    $_SESSION['quizeml3'] = $_POST['quizeml'];
    return;
}

$xml = simplexml_load_string($_SESSION['lessoneml3']);
...
switch ($prop_id) { // parses xml data from array into html document
    ...
    case 1:
        ...
        <a class=active href="Unit3.php?page=1">1</a>
        <a href="Unit3.php?page=2">2</a>
        <a href="Unit3.php?page=3">3</a>
        <a href="Unit3.php?page=4">Quiz</a>
        </div>';
    ...
    case 2:
        $pag = '<div class="pagination">
        <a href="Unit3.php?page=1">1</a>
        <a class=active href="Unit3.php?page=2">2</a>
        <a href="Unit3.php?page=3">3</a>
        <a href="Unit3.php?page=4">Quiz</a>
    </div>';
    ...
    case 3:
        ...
        <a href="Unit3.php?page=1">1</a>
        <a href="Unit3.php?page=2">2</a>
        <a class=active href="Unit3.php?page=3">3</a>
        <a href="Unit3.php?page=4">Quiz</a>
    </div>';
        for ($x = 6; $x < 8; $x++) { // iterates the required lessons in part 3 of the Unit
            $body.='<p style="margin: 20px;">' . $lessonUnit[$x]["info"];
            $body.='<br><br><b>Markup:</b><br><br><img src=' . $lessonUnit[$x]["markup"] .'></p>'; // MIGHT NEED QUOTES HERE FOR FILEPATH
        }
    ...
    case 4:
        ...
        <a href="Unit3.php?page=2">2</a>
        <a href="Unit3.php?page=3">3</a>
        <a class=active href="Unit3.php?page=4">Quiz</a>
        </div>';


        $xml = simplexml_load_string($_SESSION['quizeml3']);
...
$template->assign('title', 'Lesson 3: Intro to XML and Ajax'); // assign content values
